...
public class ProgMain {
	...
	public static void main(String[] args) {
		...
		//or from database
		bs.loadDataDB("Carturesti"); //this method takes too long to complete
		...
		Bookshop bsClone2;
		try {
			bsClone2 = (Bookshop) bs.clone(); //new Bookshop();   //without fetching data from DB
			//add clonable!!
